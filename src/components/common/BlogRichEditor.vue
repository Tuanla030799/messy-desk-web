<template>
  <div class="rounded-[1.5rem] border-2 border-ink bg-white shadow-soft-doodle">
    <div
      class="flex flex-wrap items-center justify-between gap-3 border-b-2 border-ink p-3"
    >
    ...
    <div v-if="mode === 'markdown'" class="p-4">
      <UiTextarea
...
const markdownValue = defineModel<string>("markdown", {
  default: "# Hello post\n\nWrite markdown here.",
});
const htmlValue = defineModel<string>("html", {
  default: "<h2>Hello post</h2><p>Write rich content here.</p>",
});
