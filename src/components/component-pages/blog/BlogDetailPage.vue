<template>
  <LayoutPageMain>
    ...
    <LayoutPageSection v-else max-width="md">
      <FeedbackEmptySketch title="Post not found" description="Maybe it is still hiding in the sketchbook." />
    </LayoutPageSection>
  </LayoutPageMain>
</template>
...
const breadcrumbItems = computed(() => [
  { label: 'Blog', to: '/blog' },
  { label: post?.title || 'Post not found' },
])
